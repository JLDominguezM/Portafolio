...
function Header() {
  return (
    <header className="fixed top-0 left-0 w-full bg-white dark:bg-dark-card shadow-md z-10">
      <nav className="container mx-auto max-width flex justify-between items-center py-4">
        <div className="text-lg font-bold text-dark-heading dark:text-light-heading">
        ...
        {/* Menú de navegación */}
        <ul className="flex space-x-6 text-content">
          <li>
            <Link activeClass="active" to="home" spy={true} smooth={true} duration={500} className="cursor-pointer hover:text-green-500">
              Home
            </Link>
          </li>
          <li>
            <Link activeClass="active" to="about" spy={true} smooth={true} duration={500} className="cursor-pointer hover:text-green-500">
              About
            </Link>
          </li>
          <li>
            <Link activeClass="active" to="projects" spy={true} smooth={true} duration={500} className="cursor-pointer hover:text-green-500">
              Projects
            </Link>
          </li>
          <li>
            <Link activeClass="active" to="technologies" spy={true} smooth={true} duration={500} className="cursor-pointer hover:text-green-500">
              Technologies
            </Link>
          </li>
          <li>
            <Link activeClass="active" to="contact" spy={true} smooth={true} duration={500} className="cursor-pointer hover:text-green-500">
              Contact
            </Link>
          </li>
        </ul>
